...
const chkList = $("div.chk-list-box").find(":checkbox");
$("div.chk-all-box").find(":checkbox").on('change', function () {
    if($(this).is(":checked")){
